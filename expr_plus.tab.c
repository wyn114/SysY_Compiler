...
{
       0,   111,   111,   112,   113,   114,   118,   123,   124,   125,
     126,   127,   128,   129,   130
};
#endif
...
static const char *const yytname[] =
{
  ...
  "MULTIPLY", "DIVIDE", "LPAREN", "RPAREN", "NUMBER", "ID", "ASSIGN",
  "UMINUS", "';'", "$accept", "lines", "statement", "expr", YY_NULLPTR
};
...
{
     -10,    16,   -10,    -2,    -2,   -10,    -8,   -10,    -9,    27,
     -10,   -10,    31,    -2,   -10,    -2,    -2,    -2,    -2,   -10,
     -10,    38,    12,    12,   -10,   -10
};
...
static const yytype_int8 yytable[] =
{
      ...
      21,     0,    22,    23,    24,    25,     2,    17,    18,     0,
       3,     0,     0,     4,     0,     5,     6,     0,     0,     7,
      15,    16,    17,    18,    15,    16,    17,    18,     0,    20,
      19,    15,    16,    17,    18
};
...
#line 111 "expr_plus.y"
                       { printf("%f\n", (yyvsp[-1].num)); }
#line 1232 "expr_plus.tab.c"
    break;

  case 6: /* statement: ID ASSIGN expr  */
#line 118 "expr_plus.y"
                           { addSymbol((yyvsp[-2].id), (yyvsp[0].num)); (yyval.num) = (yyvsp[0].num);}
#line 1238 "expr_plus.tab.c"
    break;

  case 7: /* expr: expr ADD expr  */
#line 123 "expr_plus.y"
                     { (yyval.num) = (yyvsp[-2].num) + (yyvsp[0].num); }
#line 1244 "expr_plus.tab.c"
    break;

  case 8: /* expr: expr MINUS expr  */
#line 124 "expr_plus.y"
                       { (yyval.num) = (yyvsp[-2].num) - (yyvsp[0].num); }
#line 1250 "expr_plus.tab.c"
    break;

  case 9: /* expr: expr MULTIPLY expr  */
#line 125 "expr_plus.y"
                          { (yyval.num) = (yyvsp[-2].num) * (yyvsp[0].num); }
#line 1256 "expr_plus.tab.c"
    break;

  case 10: /* expr: expr DIVIDE expr  */
#line 126 "expr_plus.y"
                        { (yyval.num) = (yyvsp[-2].num) / (yyvsp[0].num); }
#line 1262 "expr_plus.tab.c"
    break;

  case 11: /* expr: MINUS expr  */
#line 127 "expr_plus.y"
                               { (yyval.num) = -(yyvsp[0].num); }
#line 1268 "expr_plus.tab.c"
    break;

  case 12: /* expr: NUMBER  */
#line 128 "expr_plus.y"
              { (yyval.num) = (yyvsp[0].num); }
#line 1274 "expr_plus.tab.c"
    break;

  case 13: /* expr: ID  */
#line 129 "expr_plus.y"
          { char* tmp = malloc(50*sizeof(char));strcpy(tmp, (yyvsp[0].id));(yyval.num) = getValue(tmp); }
#line 1280 "expr_plus.tab.c"
    break;

  case 14: /* expr: LPAREN expr RPAREN  */
#line 130 "expr_plus.y"
                          { (yyval.num) = (yyvsp[-1].num); }
#line 1286 "expr_plus.tab.c"
    break;


#line 1290 "expr_plus.tab.c"
